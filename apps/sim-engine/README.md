...
> The following section assumes execution of commands are from within this directory (i.e. [/apps/engine](/apps/sim-engine) relative to the repository root). As such, paths are relative to the folder this README is in.
