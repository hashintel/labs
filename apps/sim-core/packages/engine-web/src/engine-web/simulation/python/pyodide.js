...
/**
 * When upgrading Pyodide (see the README for details), place the contents of the
 * downloaded pyodide.js inside the function getPyodideLoader below.
 */

export const getPyodideLoader = () => {
  /**
