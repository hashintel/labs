...
dbutils.widgets.text("SCN002_ENABLED", "false", "SCN002: Contamination")
dbutils.widgets.text("SCN003_ENABLED", "false", "SCN003: Fire Damage")
dbutils.widgets.text("SCN004_ENABLED", "false", "SCN004: Production Shutdown")
dbutils.widgets.text("SCN005_ENABLED", "false", "SCN005: Batch Quarantine (Single)")
dbutils.widgets.text("SCN006_ENABLED", "false", "SCN006: Batch Quarantine (All)")
dbutils.widgets.text("SCN007_ENABLED", "false", "SCN007: Product Write-off")
dbutils.widgets.text("SCN008_ENABLED", "false", "SCN008: Temperature Issue")
dbutils.widgets.text("SCN009_ENABLED", "false", "SCN009: Reroute")
dbutils.widgets.text("SCN010_ENABLED", "false", "SCN010: Partial Shutdown (50%)")

# Inventory scenario parameters
dbutils.widgets.text("SCN001_CONFIG", "", "SCN001 Config: material,plant,sloc,qty")
dbutils.widgets.text("SCN002_CONFIG", "", "SCN002 Config: material,plant,sloc,qty")
dbutils.widgets.text("SCN003_CONFIG", "", "SCN003 Config: plant,sloc,fire_date,downtime_days")
dbutils.widgets.text("SCN004_CONFIG", "", "SCN004 Config: plant,shutdown_date,downtime_days")
dbutils.widgets.text("SCN005_CONFIG", "", "SCN005 Config: material,plant,sloc,batch,qty,quarantine_days")
dbutils.widgets.text("SCN006_CONFIG", "", "SCN006 Config: material,quarantine_days")
dbutils.widgets.text("SCN007_CONFIG", "", "SCN007 Config: material,plant,sloc,batch,qty")
dbutils.widgets.text("SCN008_CONFIG", "", "SCN008 Config: material,plant,from_sloc,to_sloc,qty")
dbutils.widgets.text("SCN009_CONFIG", "", "SCN009 Config: plant,sloc,reroute_date,downtime_days")
dbutils.widgets.text("SCN010_CONFIG", "", "SCN010 Config: plant,shutdown_date,downtime_days")

# Supplier scenario toggles (true/false)
dbutils.widgets.text("SCN021_ENABLED", "false", "SCN021: Supplier Drift")
dbutils.widgets.text("SCN022_ENABLED", "false", "SCN022: CMO Deviation")
dbutils.widgets.text("SCN023_ENABLED", "false", "SCN023: FDA 483")
dbutils.widgets.text("SCN024_ENABLED", "false", "SCN024: Vendor OTIF Decline")
dbutils.widgets.text("SCN025_ENABLED", "false", "SCN025: CAPA Failures")
dbutils.widgets.text("SCN026_ENABLED", "false", "SCN026: CAPA Improvement")

# Supplier scenario parameters (vendor,material,target_otif,months_affected)
dbutils.widgets.text("SCN021_CONFIG", "", "SCN021 Config: vendor,material,target_otif,months")
dbutils.widgets.text("SCN022_CONFIG", "", "SCN022 Config: vendor,material,target_otif,months")
dbutils.widgets.text("SCN023_CONFIG", "", "SCN023 Config: vendor,material")
dbutils.widgets.text("SCN024_CONFIG", "", "SCN024 Config: vendor,material,target_otif,months")
dbutils.widgets.text("SCN025_CONFIG", "", "SCN025 Config: vendor,material,target_otif,months")
dbutils.widgets.text("SCN026_CONFIG", "", "SCN026 Config: vendor,material,target_otif,months")

# Production scenario toggles (true/false)
dbutils.widgets.text("SCN011_ENABLED", "false", "SCN011: Demand Increase")
dbutils.widgets.text("SCN012_ENABLED", "false", "SCN012: New Product Introduction")
dbutils.widgets.text("SCN013_ENABLED", "false", "SCN013: Batch Expedition")
dbutils.widgets.text("SCN014_ENABLED", "false", "SCN014: Limited Capacity")
dbutils.widgets.text("SCN015_ENABLED", "false", "SCN015: Equipment Failure")
dbutils.widgets.text("SCN016_ENABLED", "false", "SCN016: Competing Production")
dbutils.widgets.text("SCN017_ENABLED", "false", "SCN017: Regulatory Inspection")
dbutils.widgets.text("SCN018_ENABLED", "false", "SCN018: New Production Facility")
dbutils.widgets.text("SCN019_ENABLED", "false", "SCN019: Product Shortage")
dbutils.widgets.text("SCN020_ENABLED", "false", "SCN020: High Volatility")

# Production scenario parameters
dbutils.widgets.text("SCN011_CONFIG", "", "SCN011 Config: material,plant,increase_pct,start_date")
dbutils.widgets.text("SCN012_CONFIG", "", "SCN012 Config: new_material,plant,base_material")
dbutils.widgets.text("SCN013_CONFIG", "", "SCN013 Config: material,plant,qty,due_date")
dbutils.widgets.text("SCN014_CONFIG", "", "SCN014 Config: plant,capacity_pct,duration_days")
dbutils.widgets.text("SCN015_CONFIG", "", "SCN015 Config: plant,failure_date,downtime_days,cancel_ratio")
dbutils.widgets.text("SCN016_CONFIG", "", "SCN016 Config: plant,materials,contention_pct")
dbutils.widgets.text("SCN017_CONFIG", "", "SCN017 Config: plant,start_date,freeze_days")
dbutils.widgets.text("SCN018_CONFIG", "", "SCN018 Config: new_plant,ramp_start,ramp_weeks")
dbutils.widgets.text("SCN019_CONFIG", "", "SCN019 Config: material,plant,increase_pct,duration_days")
dbutils.widgets.text("SCN020_CONFIG", "", "SCN020 Config: volatility_pct,duration_days")
...
SCN002_ENABLED = dbutils.widgets.get("SCN002_ENABLED").lower() == "true"
SCN003_ENABLED = dbutils.widgets.get("SCN003_ENABLED").lower() == "true"
SCN004_ENABLED = dbutils.widgets.get("SCN004_ENABLED").lower() == "true"
SCN005_ENABLED = dbutils.widgets.get("SCN005_ENABLED").lower() == "true"
SCN006_ENABLED = dbutils.widgets.get("SCN006_ENABLED").lower() == "true"
SCN007_ENABLED = dbutils.widgets.get("SCN007_ENABLED").lower() == "true"
SCN008_ENABLED = dbutils.widgets.get("SCN008_ENABLED").lower() == "true"
SCN009_ENABLED = dbutils.widgets.get("SCN009_ENABLED").lower() == "true"
SCN010_ENABLED = dbutils.widgets.get("SCN010_ENABLED").lower() == "true"

# Parse supplier scenario toggles
SCN021_ENABLED = dbutils.widgets.get("SCN021_ENABLED").lower() == "true"
SCN022_ENABLED = dbutils.widgets.get("SCN022_ENABLED").lower() == "true"
SCN023_ENABLED = dbutils.widgets.get("SCN023_ENABLED").lower() == "true"
SCN024_ENABLED = dbutils.widgets.get("SCN024_ENABLED").lower() == "true"
SCN025_ENABLED = dbutils.widgets.get("SCN025_ENABLED").lower() == "true"
SCN026_ENABLED = dbutils.widgets.get("SCN026_ENABLED").lower() == "true"

# Parse inventory scenario configs
SCN001_CONFIG = dbutils.widgets.get("SCN001_CONFIG")
SCN002_CONFIG = dbutils.widgets.get("SCN002_CONFIG")
SCN003_CONFIG = dbutils.widgets.get("SCN003_CONFIG")
SCN004_CONFIG = dbutils.widgets.get("SCN004_CONFIG")
SCN005_CONFIG = dbutils.widgets.get("SCN005_CONFIG")
SCN006_CONFIG = dbutils.widgets.get("SCN006_CONFIG")
SCN007_CONFIG = dbutils.widgets.get("SCN007_CONFIG")
SCN008_CONFIG = dbutils.widgets.get("SCN008_CONFIG")
SCN009_CONFIG = dbutils.widgets.get("SCN009_CONFIG")
SCN010_CONFIG = dbutils.widgets.get("SCN010_CONFIG")

# Parse supplier scenario configs
SCN021_CONFIG = dbutils.widgets.get("SCN021_CONFIG")
SCN022_CONFIG = dbutils.widgets.get("SCN022_CONFIG")
SCN023_CONFIG = dbutils.widgets.get("SCN023_CONFIG")
SCN024_CONFIG = dbutils.widgets.get("SCN024_CONFIG")
SCN025_CONFIG = dbutils.widgets.get("SCN025_CONFIG")
SCN026_CONFIG = dbutils.widgets.get("SCN026_CONFIG")

# Parse production scenario toggles
SCN011_ENABLED = dbutils.widgets.get("SCN011_ENABLED").lower() == "true"
SCN012_ENABLED = dbutils.widgets.get("SCN012_ENABLED").lower() == "true"
SCN013_ENABLED = dbutils.widgets.get("SCN013_ENABLED").lower() == "true"
SCN014_ENABLED = dbutils.widgets.get("SCN014_ENABLED").lower() == "true"
SCN015_ENABLED = dbutils.widgets.get("SCN015_ENABLED").lower() == "true"
SCN016_ENABLED = dbutils.widgets.get("SCN016_ENABLED").lower() == "true"
SCN017_ENABLED = dbutils.widgets.get("SCN017_ENABLED").lower() == "true"
SCN018_ENABLED = dbutils.widgets.get("SCN018_ENABLED").lower() == "true"
SCN019_ENABLED = dbutils.widgets.get("SCN019_ENABLED").lower() == "true"
SCN020_ENABLED = dbutils.widgets.get("SCN020_ENABLED").lower() == "true"

# Parse production scenario configs
SCN011_CONFIG = dbutils.widgets.get("SCN011_CONFIG")
SCN012_CONFIG = dbutils.widgets.get("SCN012_CONFIG")
SCN013_CONFIG = dbutils.widgets.get("SCN013_CONFIG")
SCN014_CONFIG = dbutils.widgets.get("SCN014_CONFIG")
SCN015_CONFIG = dbutils.widgets.get("SCN015_CONFIG")
SCN016_CONFIG = dbutils.widgets.get("SCN016_CONFIG")
SCN017_CONFIG = dbutils.widgets.get("SCN017_CONFIG")
SCN018_CONFIG = dbutils.widgets.get("SCN018_CONFIG")
...
# Inventory Scenario Definitions
INVENTORY_SCENARIO_DEFINITIONS = {
    ...
    "SCN008": {
        ...
        "shkzg": "H"  # Decrease stock (destruction, not transfer)
    },
    "SCN009": {
...
# These scenarios inject demand data into VBAK/VBAP/VBEP tables to reflect
# production planning conditions like demand increases, emergency orders, etc.
...
def inject_scenario(scenario_id, config, scenario_def, is_transfer=False):
    ...
    if is_transfer:
        # For 311 transfers, create two records:
        # 1. Remove from source location (H)
        # 2. Add to destination location (S)

        # Source record (decrease)
...
def inject_fire_scenario(config, df_mard, df_matdoc):
    ...
    Args:
        ...
        df_mard: Current MARD inventory DataFrame
        df_matdoc: Current MATDOC DataFrame
    ...
    # 1. Find all materials at this location with stock
    if affect_all_slocs:
        # Affect ALL storage locations at the plant
        location_stock = df_mard[
            (df_mard['WERKS'] == plant) &
            (pd.to_numeric(df_mard['LABST'], errors='coerce').fillna(0) > 0)
        ]
    else:
        # Affect only the specified storage location
        location_stock = df_mard[
            (df_mard['WERKS'] == plant) &
            (df_mard['LGORT'] == sloc) &
            (pd.to_numeric(df_mard['LABST'], errors='coerce').fillna(0) > 0)
    ...
    # 2. Create scrap records (551) for ALL stock at this location
    line_num = 1
    total_scrapped = 0
    ...
    # 3. Find and block MATDOC records during downtime period
    # Block receipts (101, 102) and issues (601, 261) at this location during downtime
    df_matdoc_copy = df_matdoc.copy()
    df_matdoc_copy['BUDAT_DT'] = pd.to_datetime(df_matdoc_copy['BUDAT'], format='%Y%m%d', errors='coerce')

    # Movement types to block at the affected location
    blocked_mvmt_types = ['101', '102', '601', '261', '311']

    # Find documents to block (during downtime, at affected location)
    if affect_all_slocs:
        # Block all movements at the plant
        block_mask = (
        ...
        # Block only movements at the specific storage location
        block_mask = (
            (df_matdoc_copy['WERKS'] == plant) &
...
def inject_shutdown_scenario(scenario_id, config, df_matdoc, capacity_pct=0):
    ...
    # Block transactions during downtime period (production-related movements)
    df_matdoc_copy = df_matdoc.copy()
    df_matdoc_copy['BUDAT_DT'] = pd.to_datetime(df_matdoc_copy['BUDAT'], format='%Y%m%d', errors='coerce')

    # Block production-related movements at the plant
    # For full shutdown (0%), block all movements
    # For partial shutdown (50%), we don't actually block - the capacity is informational
    if capacity_pct == 0:
        blocked_mvmt_types = ['101', '102', '601', '261', '311']
        block_mask = (
            (df_matdoc_copy['WERKS'] == plant) &
...
def inject_quarantine_scenario(scenario_id, config, df_mard, is_all_locations=False):
    ...
    if is_all_locations:
        ...
        # Find all stock of this material across all locations
        ...
        for _, row in material_stock.iterrows():
            ...
            if qty > 0:
                ...
                # Source record (decrease at original location)
                ...
                # Destination record (increase at QA01)
                transfer_records.append({
                    'MANDT': '800',
                    'MBLNR': doc_num,
                    'MJAHR': str(quarantine_date.year),
        ...
        # SCN005: Quarantine specific batch at specific location
        plant = config['plant']
        sloc = config['sloc']
        batch = config['batch']
        qty = config['qty']
...
def inject_temperature_scenario(config, df_mard):
    ...
    # Find all materials at this location with stock
    location_stock = df_mard[
        (df_mard['WERKS'] == plant) &
        (df_mard['LGORT'] == sloc) &
        (pd.to_numeric(df_mard['LABST'], errors='coerce').fillna(0) > 0)
    ...
    # Create scrap records (551) for ALL stock at this location
    total_scrapped = 0
    posting_date = datetime.now().strftime('%Y%m%d')
...
def inject_reroute_scenario(config, df_mard, df_matdoc):
    ...
    # 2. Create transfer records (311) to move ALL stock to QA01
    total_quarantined = 0
    line_num = 1
    ...
    # 3. Block transactions during downtime period
    df_matdoc_copy = df_matdoc.copy()
    df_matdoc_copy['BUDAT_DT'] = pd.to_datetime(df_matdoc_copy['BUDAT'], format='%Y%m%d', errors='coerce')
...
def update_mard_for_scenario(df_mard, matdoc_records):
    """
    Update MARD inventory levels based on scenario MATDOC records.

    Args:
        df_mard: Pandas DataFrame of MARD
        matdoc_records: List of MATDOC record dicts

    Returns:
        Updated MARD DataFrame
    """
...
def adjust_goods_issues_for_scenario(df_matdoc, scenario_records, df_mard, df_lips=None, df_likp=None, df_vbfa=None):
    """
    Adjust or remove 601 goods issues that would cause negative inventory after scenario injection.
    Also cascades changes to related tables (LIPS, LIKP, VBFA).

    When a scenario reduces inventory (e.g., SCN001 stock deviation, SCN002 contamination),
    the planned 601 movements may now exceed available stock. This function:
    1. Identifies affected materials/plants/locations
    2. Calculates available stock after scenario
    3. Reduces or removes 601 movements that would cause negative inventory
    4. Cascades changes to LIPS, LIKP, VBFA to maintain data consistency

    Args:
        df_matdoc: Pandas DataFrame of all MATDOC records (including scenario records)
        scenario_records: List of scenario MATDOC record dicts
        df_mard: Pandas DataFrame of MARD with updated stock levels
        df_lips: Optional Pandas DataFrame of LIPS (delivery items)
        df_likp: Optional Pandas DataFrame of LIKP (delivery headers)
        df_vbfa: Optional Pandas DataFrame of VBFA (document flow)

    Returns:
        Tuple of (df_matdoc, df_lips, df_likp, df_vbfa) - all updated DataFrames
    """
    ...
    # Find scenarios that reduce inventory
    ...
    for scenario in reducing_scenarios:
        ...
        # Get current stock from MARD for this location
        ...
        # Find 601 movements for this material/plant/location AFTER the scenario date
        # These are the movements that might cause negative inventory
        issue_mask = (
            (df_matdoc['BWART'] == '601') &
        ...
        # Get future 601 movements sorted by date
        future_issues = df_matdoc[issue_mask].sort_values('BUDAT').copy()

        # Also get future receipts (101, 311 incoming) to track stock changes
        receipt_mask = (
        ...
        # Simulate inventory and adjust issues
        simulated_stock = current_stock
        indices_to_remove = []
        indices_to_reduce = {}

        # Combine issues and receipts, sorted by date
        ...
        for idx, row in all_movements.iterrows():
            ...
            if row.get('is_issue', False):
                # This is a 601 issue - check if we have enough stock
                if simulated_stock <= 0:
                    # No stock - remove this issue entirely
                ...
                # This is a receipt - add to stock
                simulated_stock += qty
    ...
    if (removed_deliveries or reduced_deliveries) and df_lips is not None:
        ...
        # Remove LIPS records for removed deliveries
        ...
        # Update VBFA document flow
        if df_vbfa is not None:
            # Remove document flow for removed deliveries
            for delivery_vbeln, matnr in removed_deliveries:
                vbfa_mask = (df_vbfa['VBELN_N'] == delivery_vbeln)
                df_vbfa = df_vbfa[~vbfa_mask]

            # Update quantities in VBFA for reduced deliveries
            for delivery_vbeln, matnr, new_qty in reduced_deliveries:
                vbfa_mask = (df_vbfa['VBELN_N'] == delivery_vbeln)
                if vbfa_mask.any():
...
def generate_mardh(df_matdoc, df_mard_initial):
    ...
    # Aggregate movements by material, plant, storage location, and period
    ...
    # Get all unique combinations and periods
    ...
    # For each material-plant-sloc combination, calculate running stock
    for _, key in all_keys.iterrows():
        ...
        for _, period in all_periods.iterrows():
            ...
            # Apply any movements for this period
...
def parse_supplier_config(config_str, scenario_type="standard"):
    ...
    if scenario_type == "fda":
        # FDA 483 only needs vendor and material
        if len(parts) < 2:
...
def parse_production_config(config_str, scenario_type="demand_increase"):
    ...
    if scenario_type == "demand_increase":
        ...
        # SCN012: new_material,plant,base_material
        if len(parts) != 3:
        ...
        # SCN015: plant,failure_date,downtime_days,cancel_ratio
        if len(parts) != 4:
        ...
        # SCN017: plant,start_date,freeze_days
        if len(parts) != 3:
        ...
        # SCN018: new_plant,ramp_start,ramp_weeks
        if len(parts) != 3:
        ...
        # SCN014: plant,capacity_pct,duration_days
        if len(parts) != 3:
        ...
        # SCN016: plant,materials,contention_pct (materials is semicolon-separated)
        if len(parts) != 3:
        ...
        # SCN020: volatility_pct,duration_days
        if len(parts) != 2:
...
def inject_demand_increase(scenario_id, config, df_vbak, df_vbap, df_vbep, df_kna1):
    ...
    # Find existing orders for this material/plant to calculate baseline
    ...
    # Calculate how many new orders to create to achieve the increase
...
def inject_shortage_demand(scenario_id, config, df_vbak, df_vbap, df_vbep, df_kna1):
    ...
    # Find existing orders for this material/plant
    existing_orders = df_vbap[
        (df_vbap['MATNR'] == material) &
        (df_vbap['WERKS'] == plant)
    ]
    ...
    # For shortage, create many urgent orders
    ...
    for i in range(num_new_orders):
        vbeln = str(next_vbeln + i)
        # Spread orders over the duration, but with tight delivery dates
        order_date = start_date + timedelta(days=random.randint(0, duration_days // 2))
        # Very short delivery window for critical shortage
...
def inject_new_product(scenario_id, config, df_mara, df_makt, df_marc, df_mast, df_stpo, df_vbak, df_kna1):
    ...
    # Copy BOM structure if available
    new_mast_records = []
    new_stpo_records = []
    ...
    # Create initial sales orders for the new product
    ...
    # Create 3 initial orders for the new product
    for i in range(3):
        vbeln = str(next_vbeln + i)
...
def inject_equipment_failure(scenario_id, config, df_afko):
    ...
    # Find production orders at the affected plant during downtime
    ...
    for _, order in affected_orders.iterrows():
        ...
        # Cancel ratio determines how many orders get cancelled vs rescheduled
        if random.random() < cancel_ratio:
            cancelled_orders.append(aufnr)
        else:
            # Reschedule to after recovery
...
def inject_regulatory_freeze(scenario_id, config, df_likp):
    ...
    # Find deliveries during the freeze period
...
def inject_new_facility(scenario_id, config, df_sapapo_loc, df_afko, df_mara):
    ...
    # Create new location record based on existing plant
    ...
    # Get finished goods for production
    finished_goods = df_mara[df_mara['MTART'] == 'FERT']['MATNR'].tolist()[:5]

    # Create ramping production orders
    new_afko = []
    ...
    for week in range(ramp_weeks):
        ...
        # Create 1-2 production orders per week per product (ramping)
...
def inject_limited_capacity(scenario_id, config, df_afko, df_mara):
    ...
    # Get finished goods for this plant
    finished_goods = df_mara[df_mara['MTART'] == 'FERT']['MATNR'].tolist()

    # Calculate how many orders to add to reach capacity_pct
    existing_orders = len(df_afko[df_afko['WERKS'] == plant])
    # Assume 100% capacity = existing * (100/current_utilization)
    # If we have 50 orders at ~60% utilization, 100% would be ~83 orders
    # For 95%, add orders to fill up the capacity
...
def inject_competing_production(scenario_id, config, df_afko, df_vbak, df_kna1):
    ...
    # Create overlapping production orders for competing products
    for week in range(4):  # 4 weeks of contention
        week_start = start_date + timedelta(weeks=week)

        for i, material in enumerate(materials):
            # Create 2-3 competing orders per product per week
            ...
            for j in range(num_orders):
                ...
                # Also create corresponding sales orders to drive the demand
...
def inject_high_volatility(scenario_id, config, df_vbak, df_vbap, df_vbep, df_kna1, df_mara):
    ...
    # Create variable orders with high variance (volatility)
    # More orders = higher volatility impact
    ...
    for i in range(num_volatile_orders):
        ...
        # High variance in quantities (volatility)
        ...
        # Variable lead times add to unpredictability
...
def inject_supplier_performance(df_ekbe, scenario_id, config, scenario_def):
    """
    Inject supplier performance issues into EKBE (Purchase Order History).

    Modifies delivery dates and quantities to simulate poor supplier performance.

    Args:
        df_ekbe: DataFrame with existing EKBE records
        scenario_id: SCN021, SCN022, etc.
        config: Parsed configuration dict with vendor, material, target_otif, months_affected
        scenario_def: Scenario definition from SUPPLIER_SCENARIO_DEFINITIONS

    Returns:
        Updated EKBE DataFrame
    """
    ...
    # Calculate how many records should fail OTIF
    current_otif = 0.95  # Assume baseline OTIF is 95%
    failure_rate = current_otif - target_otif  # Additional failures to inject

    if trend == 'IMPROVE':
        # For improvement, we actually want to IMPROVE the current data
        # So we'll fix some failures rather than create them
    ...
    for idx in selected_indices:
        if trend in ['DECLINE', 'STABLE'] and failure_rate > 0:
            ...
            if random.random() < 0.6:  # 60% chance of late delivery
                # Make delivery late (5-21 days late)
            ...
            if random.random() < 0.4:  # 40% chance of partial delivery
                # Reduce quantity (50-85% of ordered)
            ...
            # Fix existing failures (set back to on-time/in-full)
...
# Check if any scenarios are enabled
...
if not scenarios_enabled:
    ...
    dbutils.notebook.exit("NO_SCENARIOS")
...
df_matdoc = spark.table(f"{CATALOG}.{SCHEMA}.matdoc").toPandas()
df_mard = spark.table(f"{CATALOG}.{SCHEMA}.mard").toPandas()

# Read supplier tables if supplier scenarios enabled
df_ekbe = None
if supplier_scenarios_enabled:
    try:
        df_ekbe = spark.table(f"{CATALOG}.{SCHEMA}.ekbe").toPandas()
...
# Read sales order tables if production scenarios enabled
df_vbak = None
df_vbap = None
df_vbep = None
df_kna1 = None
if production_scenarios_enabled:
    try:
        df_vbak = spark.table(f"{CATALOG}.{SCHEMA}.vbak").toPandas()
        df_vbap = spark.table(f"{CATALOG}.{SCHEMA}.vbap").toPandas()
        df_vbep = spark.table(f"{CATALOG}.{SCHEMA}.vbep").toPandas()
        df_kna1 = spark.table(f"{CATALOG}.{SCHEMA}.kna1").toPandas()
...
# Collect all scenario MATDOC records
...
if SCN003_ENABLED:
    ...
    if config:
        ...
        # Calculate total quantity scrapped (use 0.0 as default for empty sum)
...
if SCN006_ENABLED:
    ...
    if config:
        ...
        # Calculate total quantity quarantined
...
if SCN008_ENABLED:
    ...
    if config:
        ...
        # Calculate total quantity scrapped
        total_qty = sum((float(r['MENGE']) for r in scrap_records), 0.0)
...
# Process Production Scenarios (SCN011, SCN013, SCN019)
...
if production_scenarios_enabled and df_vbak is not None:
    ...
    # SCN011: Demand Increase - MAT-A0005 at plant 1000, +25% permanent
    if SCN011_ENABLED:
    ...
    # SCN013: Batch Expedition - MAT-A0010 at plant 1000, emergency order
    if SCN013_ENABLED:
    ...
    # SCN019: Product Shortage - MAT-A0020 at plant 1000, +100% for 30 days
    if SCN019_ENABLED:
    ...
    # SCN012: New Product Introduction - MAT-A0050 based on existing product
    if SCN012_ENABLED:
    ...
    # SCN015: Equipment Failure - Production line failure
    if SCN015_ENABLED:
        ...
        if config:
            ...
            try:
                ...
                # Store cancelled and rescheduled orders
    ...
    # SCN017: Regulatory Inspection - Delivery freeze
    if SCN017_ENABLED:
    ...
    # SCN018: New Production Facility - New plant ramping up
    if SCN018_ENABLED:
    ...
    # SCN014: Limited Capacity - Production line at 95% saturation
    if SCN014_ENABLED:
    ...
    # SCN016: Competing Production - Multiple products sharing production line
    if SCN016_ENABLED:
    ...
    # SCN020: High Volatility - Network-wide demand volatility
    if SCN020_ENABLED:
...
# Process Supplier Scenarios (SCN021-SCN026)
...
if inventory_changes or supplier_changes or production_changes:
    # Apply inventory scenario changes
    if inventory_changes:
        print(f"\nApplying {len(all_scenario_records)} scenario MATDOC records...")

        # Remove blocked MATDOC records (fire downtime)
        ...
        # Append scenario records to MATDOC
        ...
        # Update MARD inventory levels
        print("Updating MARD inventory levels...")
        df_mard_updated = update_mard_for_scenario(df_mard, all_scenario_records)

        # Load related tables for cascading updates
        print("Loading related tables (LIPS, LIKP, VBFA) for cascade...")
        try:
            df_lips = spark.table(f"{CATALOG}.{SCHEMA}.lips").toPandas()
            df_likp = spark.table(f"{CATALOG}.{SCHEMA}.likp").toPandas()
            df_vbfa = spark.table(f"{CATALOG}.{SCHEMA}.vbfa").toPandas()
        except Exception as e:
        ...
        # Adjust 601 goods issues to prevent negative inventory (with cascade)
        ...
        # Regenerate MARDH with scenario impacts
        print("Regenerating MARDH...")
        df_mardh_updated = generate_mardh(df_matdoc_updated, df_mard_updated)

        # Save updated inventory tables
        print("\nSaving updated inventory tables...")
        save_sap_table(spark.createDataFrame(df_matdoc_updated), "matdoc", CATALOG, SCHEMA)
        save_sap_table(spark.createDataFrame(df_mard_updated), "mard", CATALOG, SCHEMA)
        save_sap_table(spark.createDataFrame(df_mardh_updated), "mardh", CATALOG, SCHEMA)

        # Save cascaded updates to related tables
        if df_lips_updated is not None:
            save_sap_table(spark.createDataFrame(df_lips_updated), "lips", CATALOG, SCHEMA)
            print("  Saved updated LIPS")
        if df_likp_updated is not None:
            save_sap_table(spark.createDataFrame(df_likp_updated), "likp", CATALOG, SCHEMA)
            print("  Saved updated LIKP")
        if df_vbfa_updated is not None:
            save_sap_table(spark.createDataFrame(df_vbfa_updated), "vbfa", CATALOG, SCHEMA)
            print("  Saved updated VBFA")

    # Apply supplier scenario changes
    ...
    if production_changes and df_vbak is not None:
        ...
        if 'afko' in production_scenario_records and production_scenario_records['afko']:
            ...
            # Ensure PLNBEZ is populated (backfill from MATNR if available)
        ...
        # SCN015: Update AFKO with cancelled/rescheduled orders
        if 'afko_changes' in production_scenario_records:
            ...
            save_sap_table(spark.createDataFrame(df_afko), "afko", CATALOG, SCHEMA)

        # SCN017: Block deliveries in LIKP
        if 'likp_blocks' in production_scenario_records:
            ...
            if blocked:
                ...
                save_sap_table(spark.createDataFrame(df_likp), "likp", CATALOG, SCHEMA)
                print(f"  Blocked {len(blocked)} deliveries in LIKP (SCN017)")

        # SCN018: Add new facility and production orders
        if 'new_facility' in production_scenario_records:
            nf = production_scenario_records['new_facility']
            if nf.get('locations'):
                df_loc = spark.table(f"{CATALOG}.{SCHEMA}.sapapo_loc").toPandas()
                df_loc_updated = pd.concat([df_loc, pd.DataFrame(nf['locations'])], ignore_index=True)
                save_sap_table(spark.createDataFrame(df_loc_updated), "sapapo_loc", CATALOG, SCHEMA)
    ...
    # Normalize metadata records to have all fields
    normalized_metadata = []
    ...
    metadata_schema = StructType([
        ...
        StructField("mvmt_type", StringType(), True),
        StructField("material", StringType(), True),
        StructField("plant", StringType(), True),
        StructField("storage_loc", StringType(), True),
        StructField("dest_loc", StringType(), True),
        StructField("quantity", DoubleType(), True),
        StructField("downtime_days", IntegerType(), True),
        StructField("recovery_date", StringType(), True),
        StructField("vendor", StringType(), True),
        StructField("target_otif", DoubleType(), True),
        StructField("demand_increase_pct", IntegerType(), True),
        StructField("demand_type", StringType(), True),
        StructField("injected_at", TimestampType(), False),
    ])
    df_metadata = spark.createDataFrame(normalized_metadata, schema=metadata_schema)
    metadata_table = f"{CATALOG}.{SCHEMA}.scenario_metadata"
    ...
    dbutils.notebook.exit(f"SUCCESS: {len(scenario_metadata)} scenarios injected")
else:
