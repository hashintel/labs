"""Transaction data generation. Ported from hashintel/SAP_Mock_Data (Transactions notebook); logic verbatim, Spark shell replaced with pandas + Delta warehouse io."""
import os
...
def generate(wh):
    ...
    GENERATE_DIRTY_DATA = os.environ.get("GENERATE_DIRTY_DATA", "false").lower() == "true"
    DIRTY_DATA_RATE = float(os.environ.get("DIRTY_DATA_RATE", "0.05"))
