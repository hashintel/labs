"""Scenario definitions (scenario_config table). Ported from hashintel/SAP_Mock_Data (Setup Scenario Config notebook); definitions verbatim, Spark shell replaced with pandas + Delta warehouse io."""
import pandas as pd
...
def generate(wh):
    ...
    wh.save("scenario_config", df_scenarios)
    print(f"Saved {len(scenarios)} scenarios to scenario_config")
