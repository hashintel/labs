...
import { postgresPipeline } from "./pipelines.js";
import { integrate } from "./engine.js";

const root = dirname(fileURLToPath(import.meta.url));
const def: ConnectorDef = JSON.parse(readFileSync(resolve(process.argv[2] ?? resolve(root, "..", "integration-watermark.json")), "utf-8"));
