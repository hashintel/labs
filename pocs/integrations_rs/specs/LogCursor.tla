...
(*                                                                         *)
(* This module checks what the journal guarantees across takeover.        *)
(* LeaseFencing checks that a competitor cannot hold the lease inside      *)
(* another worker's chunk window; the fence in this module is the storage  *)
(* epoch at append time, while LeaseFencing fences at chunk admission.     *)
(*                                                                         *)
